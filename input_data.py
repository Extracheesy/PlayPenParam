...
# lst_ma_type = ['ALMA', 'ZLEMA', "DEMA", "HMA", "TEMA", "COMBINED"]
lst_ma_type = ['ALMA', 'ZLEMA', "DEMA", "HMA", "TEMA"]
...
if init_param:
    ...
    lst_zema_len_buy = list(range(30, 71, 10))  # 30,35,40,45,50,55,60,65,70
    lst_zema_len_sell = list(range(50, 91, 10)) # 50,55,60,65,70,75,80,85,90
